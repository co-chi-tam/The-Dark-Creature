...
public class CUIScrollRectSnapPage : CUIScrollRectCustom, IUserInterface {
...
//						direction = new Vector3 (Input.GetTouch (0).position.x, Input.GetTouch (0).position.y, 0f) - m_PosDrag;
//					}
//				}
